...
<!-- Filter Box -->
<div class="bg-bgSurface-light dark:bg-bgSurface-dark rounded-2xl border border-gray-100 dark:border-gray-800 p-6 mb-6">
 ...
 <button class="flex-1 py-2 rounded-md bg-navy-light dark:bg-teal-600 text-white text-xs font-medium hover:bg-navy-dark dark:hover:bg-teal-700 transition-colors">
 Terapkan Filter
 </button>
